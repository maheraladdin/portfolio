...
import { codepenUrl, githubUrl, linkedinUrl, twitterUrl } from "@/lib/data";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Maher.</span> I have accumulated{" "}
        <span className={"font-bold"}>4 years</span> of experience in{" "}
        <span className={"italic"}>self-directed learning</span> ,and{" "}
        <span className={"italic"}>hands-on project development</span> in the
        field of{" "}
        <span className={"font-bold"}> full-stack JavaScript development</span>.
        <br />I enjoy building <span className="italic">sites & apps</span>. My
        focus is <span className="underline">React (Next.js)</span>.
      </motion.h1>

      <motion.div
        className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 pb-4 sm:pt-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
